...
class PreferencesDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesUbuntuPomadoroTasksDialog')
        new_object = builder.get_object("preferences_ubuntu_pomadoro_tasks_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesUbuntuPomadoroTasksDialog
        instance.

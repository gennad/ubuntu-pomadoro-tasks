...
from . ubuntu_pomadoro_tasksconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('ubuntu-pomadoro-tasks')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('ubuntu_pomadoro_tasks_lib')
...
def get_help_uri(page=None):
    ...
    if not os.path.exists(help_uri):
        ...
        help_uri = 'ubuntu-pomadoro-tasks'
